...
import type { NodeProps } from "prez-components";

const props = defineProps<NodeProps & {hidePrimaryLink?: boolean}>();
...
<template>
    ...
    <slot name="wrapper" :term="term" :link="term.value" :label="label" :tooltip="tooltip" :variant="variant">
        ...
        <ItemLink v-else :to="useExternalLinkOnly ? term.value : term" :title="hideTooltip ? undefined : tooltip" :variant="variant" :hidePrimaryLink="props.hidePrimaryLink">
